    ...
    <>
      ...
      <JsonLd
        data={serviceJsonLd({
          ...
          description:
            'Tramitación de licencias de obra en Murcia. Licencia de obra mayor, menor, apertura y actividad. Gestores de obras especializados en trámites municipales.',
        })}
      />
      <JsonLd
      ...
      <section className="section bg-gray-50">
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-heading font-bold text-primary">Tipos de Licencias de Obra en Murcia: ¿Cuál Necesitas?</h2>
          </div>
      ...
      <section className="section bg-primary text-white">
        <div className="max-w-[1280px] mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-heading font-bold text-primary">Por Qué Elegirnos para Tramitar Licencias en el Ayuntamiento de Murcia</h2>
